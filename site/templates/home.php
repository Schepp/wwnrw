...
<main>
    ...
    <article>
        ...
        <p>Sipgate<br>
            ...
            40219 Düsseldorf</p>
        <p>Parkplätze gibt hinter dem Sipgate Büro. Diese erreicht man über die Plockstraße. Wichtig: Man fährt durch eine Unterführung und direkt danach führt rechts ein kleiner Weg auf den Parkplatz (bis zum Ende durchfahren).</p>
        <!--			<div id="map">-->
    ...
    <article>
        ...
        <p>Vielen Dank an <a href="http://www.sipgate.de/">Sipgate</a> für das Bereitstellen der Räumlichkeiten! <3</p>
